        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12">
              ...
              <Card className="border-2 border-neutral-200 shadow-lg">
                <CardContent className="pt-6">
                  <form className="space-y-6">
                    ...
                    <Button type="submit" className="w-full bg-emerald-600 hover:bg-emerald-700 shadow-lg" size="lg">
                      Send Message
                    </Button>
                  </form>
                </CardContent>
            ...
            <div className="animate-fade-in">
                  ...
                  <CardHeader>
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-neutral-600">+234 800 DISTRO (347876)</p>
                        <p className="text-sm text-neutral-500 mt-1">Mon-Fri, 8am - 6pm WAT</p>
                      </div>
                    </div>
                  </CardHeader>
                </Card>
              ...
              {/* FAQ Link */}
              <div className="mt-8 p-6 bg-emerald-50 rounded-xl border-2 border-emerald-100">
                <h3 className="font-semibold text-neutral-900 mb-2">Need Quick Answers?</h3>
                <p className="text-neutral-600 mb-4">Check our support center for instant help.</p>
                <Link href="/support">
