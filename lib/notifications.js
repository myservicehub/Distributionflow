  ...
  try {
    ...
    const { data, error } = await supabase
      ...
      .insert({
        ...
        title,
        message,
        type: category, // Database 'type' column expects category value ('payment', 'order', 'inventory', etc.)
