...
export const NAVIGATION_ITEMS = {
  admin: [
    ...
    { name: 'Product-Empty Links', href: '/dashboard/product-empty-links', icon: 'Link2' },
    { name: 'Orders', href: '/dashboard/orders', icon: 'ShoppingCart' },
    { name: 'Delivery Board', href: '/dashboard/delivery-board', icon: 'Truck' },
    { name: 'Delivery Analytics', href: '/dashboard/delivery-analytics', icon: 'BarChart3' },
    { name: 'Payments', href: '/dashboard/payments', icon: 'CreditCard' },
    { name: 'Bottle Exchange', href: '/dashboard/bottle-exchange', icon: 'RefreshCw' },
    { name: 'Reports', href: '/dashboard/reports', icon: 'BarChart3' },
    { name: 'Empty Inventory Overview', href: '/dashboard/empty-inventory-overview', icon: 'Package' },
    { name: 'Empty Items', href: '/dashboard/empty-items', icon: 'Package' },
    { name: 'Issue Empties to Retailers', href: '/dashboard/issue-empties', icon: 'Send' },
    { name: 'Retailer Empty Balances', href: '/dashboard/retailer-empty-balances', icon: 'Store' },
    { name: 'Manufacturer Supply', href: '/dashboard/manufacturer-supply', icon: 'Truck' },
    { name: 'Staff', href: '/dashboard/staff', icon: 'Users' },
    { name: 'Billing', href: '/settings/billing', icon: 'CreditCard' },
    { name: 'Activity Log', href: '/dashboard/activity-log', icon: 'FileText' },
    { name: 'Notifications', href: '/dashboard/notification-settings', icon: 'Bell' },
